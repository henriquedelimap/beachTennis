...
export const Vector2 = (prop: Prop) => {
    ...
    return (
        <div style={{ position: 'absolute', top: top, left: left, right: right, transform: `rotate(${rotate}deg)` }}>
            ...
            <motion.rect x="15" y="15" width="570" height="570" rx="49" stroke={color} stroke-width="100" style={{ pathLength: scrollYProgress, rotate: scrollYProgress, transformOrigin: 'top center' }}/>
            </motion.svg>
