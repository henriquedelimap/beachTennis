    ...
    return (
        <>
            ...
            <Stack sx={{ overflow: 'hidden', position: 'relative', background: '#111217' }} direction='row' justifyContent='center' alignItems='center'>
                ...
                <Vector2 top={75} left={'-14%'} rotate={-90} color={'#ffffff'} />
                <Vector2 top={150} left={'-18%'} rotate={-90} color={'#D73F33'} />
                <Vector2 top={0} right={'-10%'} rotate={-180} color={'#D73F33'} />
                <Vector2 top={75} right={'-14%'} rotate={-180} color={'#ffffff'} />
                <Vector2 top={150} right={'-18%'} rotate={-180} color={'#0066cc'} />
            </Stack>
