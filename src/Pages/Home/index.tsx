    ...
    return (
        <>
            ...
            <Stack sx={{ overflow: 'hidden', position: 'relative', background: '#111217' }} direction='row' justifyContent='center' alignItems='center'>
                ...
                <Vector2 index={1} top={-10} left={'-10%'} rotate={-90} color={'#0066cc'} />
                <Vector2 index={1} top={55} left={'-14%'} rotate={-90} color={'#ffffff'} />
                <Vector2 index={1} top={125} left={'-18%'} rotate={-90} color={'#D73F33'} />
                <Vector2 index={1} top={190} left={'-22%'} rotate={-90} color={'#0066cc'} />
                ...
                <Vector2 index={1} top={-10} right={'-10%'} rotate={-90} color={'#D73F33'} />
                <Vector2 index={1} top={55} right={'-14%'} rotate={-90} color={'#ffffff'} />
                <Vector2 index={1} top={125} right={'-18%'} rotate={-90} color={'#0066cc'} />
                <Vector2 index={1} top={190} right={'-22%'} rotate={-90} color={'#D73F33'} />
